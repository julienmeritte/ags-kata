...
import com.ags.kata.application.service.OffreOrchestrationService;
import com.ags.kata.application.service.OffreQueryService;
...
class OffreControllerTest {
    ...
    void shouldReturnCreated_WhenCreatingOffre_GivenCreationOffreRequestDto() throws Exception {
        ...
        when(offreOrchestrationService.creerOffre(any(CreationOffreRequestDto.class)))
