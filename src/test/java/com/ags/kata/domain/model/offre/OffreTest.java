...
class OffreTest {
    ...
    void shouldBeValid_WhenCreatingOffre_GivenValidData() {
        Offre offre = new Offre(OFFRE_ID, creerMarche(), Set.of(creerBloc()));
    ...
    void shouldFail_WhenCreatingOffre_GivenNullId() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Offre(null, marche, blocs));
    }

    @Test
    void shouldFail_WhenCreatingOffre_GivenNullMarche() {
        var blocs = Set.of(creerBloc());
        assertThrows(IllegalArgumentException.class, () -> new Offre(OFFRE_ID, null, blocs));
    }

    @Test
    void shouldFail_WhenCreatingOffre_GivenNullBlocs() {
        var marche = creerMarche();
        assertThrows(IllegalArgumentException.class, () -> new Offre(OFFRE_ID, marche, null));
    }
    ...
    void shouldFail_WhenCreatingOffre_GivenEmptyBlocs() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Offre(OFFRE_ID, marche, blocs));
    }
}